...
export default function TodayTaskSection() {
  ...
  const { isCollapsed, toggleCollapsed } = useSectionCollapse("today")
  ...
  const openEditDialog = (task: TodayTask) => {
    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
        ...
        <CardHeader className="flex flex-col gap-4">
          <div className="flex items-start justify-between gap-4">
                ...
                <CardTitle className="flex items-center gap-2 text-xl font-semibold">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="cursor-pointer">✅ 오늘의 할 일</span>
                    </TooltipTrigger>
                    ...
                    <TooltipContent
                      ...
                      className="max-w-xs"
                    >
                      <p>{SECTION_DESCRIPTIONS.today}</p>
                    </TooltipContent>
                  </Tooltip>
                </CardTitle>
            ...
            <Button
              ...
              aria-label={
                isCollapsed ? "오늘의 할 일 펼치기" : "오늘의 할 일 접기"
              }
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>✍️ 오늘 할 일 추가</DialogTitle>
            <DialogDescription>
              오늘 해야 할 일을 짧고 명확하게 적어보세요
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="space-y-2">
            <DialogTitle>오늘 할 일 수정</DialogTitle>
            <DialogDescription>
